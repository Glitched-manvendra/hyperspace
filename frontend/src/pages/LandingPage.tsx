...
export default function LandingPage({ onLaunch }: LandingPageProps) {
  return (
    <div className="h-screen overflow-y-auto custom-scrollbar bg-background text-gray-100 relative">
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-glass-border">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-3">
        ...
        <button
          onClick={onLaunch}
          className="px-5 py-2 rounded-full border border-white/10 hover:bg-white/5 transition-colors text-sm font-medium"
        >
          Launch Dashboard
        </button>
      </div>
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-20 overflow-hidden">
      ...
      >
        ...
        >
          Guided Farming with{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-blue-400 text-glow">
        ...
        >
          ...
          <a
            href="#problem"
            className="inline-flex items-center gap-2 px-7 py-4 rounded-full border border-white/10 text-sage hover:text-white hover:border-white/20 font-medium transition-all"
          >
            Learn More
        ...
        >
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className={`w-24 h-24 rounded-2xl bg-gradient-to-br ${s.gradient} grid place-items-center shadow-lg shadow-primary/10 mb-6 animate-pulse-glow`}>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          {sources.map((s, i) => (
            ...
            >
              <div className={`w-12 h-12 rounded-xl bg-white/5 border border-white/10 grid place-items-center mx-auto mb-4 ${s.color}`}>
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          {badges.map((b, i) => (
            ...
            >
              <div className={`w-14 h-14 rounded-full bg-white/5 border border-white/10 grid place-items-center mx-auto mb-5 ${b.color}`}>
  ...
  return (
    <section className="py-20 px-6">
      <motion.div
        ...
        className="max-w-4xl mx-auto glass-panel rounded-3xl relative overflow-hidden"
      >
        {/* Glow behind */}
        ...
        <div className="relative z-10 flex flex-col items-center text-center py-16 px-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onLaunch}
            className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-background font-bold rounded-full text-sm shadow-[0_0_40px_rgba(255,255,255,0.2)] hover:shadow-[0_0_60px_rgba(255,255,255,0.35)] transition-shadow"
          >
